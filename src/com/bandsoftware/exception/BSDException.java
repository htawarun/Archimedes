...
public class BSDException extends RuntimeException {
    ...
    public BSDException(String argMessage, Object exObj) {
        super(argMessage);
        init("", argMessage, exObj);
    }

    public BSDException(int msgNum, String argMessage, Object ex) {
        super(argMessage);
        init("", argMessage, ex);
        setMessageNum(msgNum);
    }

    public BSDException(String msgName, int msgNum, String argMessage, Object ex) {
        super(argMessage);
        init(msgName, argMessage, ex);
        setMessageNum(msgNum);
    }

    public BSDException(String msgName, String argMessage, Object ex) {
        super(argMessage);
        init(msgName, argMessage, ex);
    }

    private void init(String exName, String exMsg, Object exObj) {
        name = exName;
        message = exMsg;
        object = exObj;
    }
    ...
    public String toString() {
        ...
        if (object != null) {
            if (object instanceof Throwable) {
                buf.append('\n').append(VSException.getExceptionString((Throwable) object));
            }
    ...
    public Object getPriorException() {
        return object;
    }
}
