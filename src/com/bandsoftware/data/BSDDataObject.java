...
public class BSDDataObject extends Object {

    public String BO_Name;                                    // Name of this Business Object
    public String QRY_Name;                                 // Used only if Query Object instead of Business Object
    private Hashtable attrList = new Hashtable();           // List of Attributes
    private Vector myChildren = new Vector();                // List of Child BSDDataObjects
    private BSDDataObject myParent = null;                    // Link to parent BSDDataObject
    private Hashtable keys = new Hashtable();               //primary keys
    public boolean WhereUsedAware = true;  // only sends messages to where used objects
    public Vector usedBy = null;               // each object contains a collection of WhereUsedDO objects
    ...
    //Return the Query Object name to use if found, else return the BO_Name base table name
    ...
    public void clone(BSDDataObject existingObject) {
        ...
        Enumeration e = existingObject.getAttrList();
        while (e.hasMoreElements()) {
...
//	db("Child found " + o.getClass().getName());
    ...
    public void testString() {
        ...
        //String BO_Name; 		// Name of this Business Object
        ...
        db("*******************************", anOutputStream);
        db("BO Name " + BO_Name, anOutputStream);
...
*/
     ...
     *
     * @param BSDDataObject The BSDDataObject which initiated the event handler.
    ...
    public void recursiveReposVersion() {
        //walk the tree and set all chindren to this versioni
        Enumeration e = this.getChildren();
        BSDDataObject bsdObj;
        BSDDataObject child;
        while (e.hasMoreElements()) {
            bsdObj = (BSDDataObject) e.nextElement();
            db("childName :" + bsdObj.getName());
            bsdObj.setAttrValue("RepositoryName", bsdObj.getParent().getAttrValue("RepositoryName"));
        }
        Enumeration children = this.getChildren();
        while (children.hasMoreElements()) {
            child = (BSDDataObject) children.nextElement();
            child.recursiveReposVersion();
        }
    }
}