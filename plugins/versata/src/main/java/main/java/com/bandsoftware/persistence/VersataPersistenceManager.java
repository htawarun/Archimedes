...
public class VersataPersistenceManager {
    ...
    //************************************
    public VersataPersistenceManager() {
        super();
    }

    public VersataPersistenceManager(RepositoryDO root) {
        super();
        setRootDO(root);
    }
    ...
    //*******************************************
    public VersataPersistenceManager(RepositoryDO root, Object sess) {
        super();
        setRootDO(root);
        setSession(sess);
    }
    ...
    public VersataPersistenceManager(String event, RepositoryDO root, Object sess) {
        super();
        setSession(sess);
        setRootDO(root);
    }
    ...
    //========================================================================================
    public Hashtable getHashtable(BSDDataObject bsdDataObject) {
    ...
    public void setAttrs(BSDDataObject bsdDataObject, VSRow row) {
    ...
    public void insert(BSDDataObject bsdDataObject) {
        ...
        try {
            ...
            Hashtable ht = getProcessor().insertData(bsdDataObject.getQueryName(), getHashtable(bsdDataObject));
    ...
    public void close() {
        ...
        //repositoryDO.close(); // do not close here - this may be needed by the caller to process additional stuff like errors and acks
