...
public class DataObjectDO extends BusinessObjectDO {
    ...
    private boolean CodedValueList;
    ...
    private Vector parentReln = new Vector();
    private Vector childReln = new Vector();
    private Vector persistentAttrs = null;
    ...
    public void setCodedValueList(boolean codedValueList) {
        setAttrValue("CodedValueList", (codedValueList == true) ? "true" : "false");
    ...
    public void testString() {
        ...
        db("CodedValueList Name " + CodedValueList);
        db("Alias Name " + Alias);
