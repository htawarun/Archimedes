...
public class RecordSourceDO extends BusinessObjectDO {
    ...
    private Vector rsAttributes = new Vector();
            ...
            if (rsNode != null) {
                ...
                if (nodelist != null) {
                    while ((anode = (IXMLDOMNode) nodelist.item(i)) != null) {
                        ...
                        scalar = ("ScalerAttributes".equals(anode.getNodeName())) ? "true" : "false";
    ...
    public void setAllowDelete(String allowDelete) {
        setAttrValue("AllowDelete", allowDelete);
    ...
    public void setAllowUpdate(String allowUpdate) {
        setAttrValue("AllowUpdate", allowUpdate);
    ...
    public void setAllowInsert(String allowInsert) {
        setAttrValue("AllowInsert", allowInsert);
